...
export const  Notification = ()=> {
  ...
  return (
    <div className="relative inline-block text-sm font-medium text-center text-gray-500 hover:text-gray-900 focus:outline-none">
      <button
      ...
      {isDropdownVisible && (
        <div
          className="z-20 w-full max-w-sm bg-white divide-y divide-gray-100 rounded-lg shadow"
